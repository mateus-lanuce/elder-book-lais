...
import type { TransparencyType, StateObjectType } from "@/utils/types";
...
const transparency = ref<TransparencyType | null>();
const SelectedState = ref<StateObjectType | undefined>();
          ...
          <div class="flex flex-col items-start space-y-2">
            ...
            <div>
              <div class="flex flex-row items-center space-x-2">
                ...
                <p class="text-themeGray-dark font-bold text-base">Usuários Totais: {{ formatNumber(SelectedState?.usuarios_totais) }}</p>
              </div>
              <div class="flex flex-row items-center space-x-2">
                <div class="h-5 w-5 rounded-full bg-themeGray-dark" />
                <p class="text-themeGray-dark font-bold text-base">Usuários com Direito a Certificação: {{ formatNumber(SelectedState?.direito_certificacao) }}</p>
              </div>
            </div>
