...
<template>
  <div class="relative">
    <div class="">
      ...
      >
        <g>
          <a xlink:href="#tocantins" @click="handleClick('TO')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
        ...
        S234.852,233.695,289.558,235.641z"
          ...
          <a xlink:href="#bahia" @click="handleClick('BA')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-0.546-1.725-5.396-6.079-0.026-7.175c-3.175,0.959-1.944-4.027,0.875-3.012C316.726,200.733,314.044,200.527,313.276,197.775z"
          ...
          <a xlink:href="#sergipe" @click="handleClick('SE')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-6.238,0-11.258-5.053-11.258-11.261C406.063,187.89,411.084,182.854,417.324,182.854z"
          ...
          <a xlink:href="#pernambuco" @click="handleClick('PE')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c0.219,0.108-8.244,6.681-7.506,3.314C383.556,170.4,374.241,168.566,373.011,167.238z"
          ...
          <a xlink:href="#alagoas" @click="handleClick('AL')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-6.241,0-11.263-5.052-11.263-11.259C425.16,173.816,430.182,168.763,436.423,168.763z"
          ...
          <a xlink:href="#riograndedonorte" @click="handleClick('RN')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-6.209,0-11.26-5.037-11.26-11.261C419.567,112.837,424.618,107.798,430.827,107.798z"
          ...
          <a xlink:href="#ceara" @click="handleClick('CE')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C373.035,102.314,374.815,105.971,372.379,104.409z"
          ...
          <a xlink:href="#piaui" @click="handleClick('PI')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C328.176,198.748,327.409,180.727,320.781,185.478z"
          ...
          <a xlink:href="#maranhao" @click="handleClick('MA')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C290.983,125.675,290.983,128.044,288.845,127.827z"
          ...
          <a xlink:href="#amapa" @click="handleClick('AP')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C221.814,36.458,223.334,38.417,225.198,39.089z"
          ...
          <a xlink:href="#para" @click="handleClick('PA')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C319.302,76.912,319.74,78.76,319.139,77.664z"
          ...
          <a xlink:href="#roraima" @click="handleClick('RR')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        s-12.517-52.736-20.335-54.063C115.261,36.417,111.523,25.682,113.18,24.107z"
          ...
          <a xlink:href="#amazonas" @click="handleClick('AM')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-8.601-4.381-16.61-8.981-26.088-11.05c-10.282-2.259-20.635-4.793-29.878-10.011C4.121,145.766,12.433,144.779,10.078,136.412z"
          ...
          <a xlink:href="#acre" @click="handleClick('AC')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c6.299-3.41-3.107-11.9-5.216-15.679c-0.52-0.918-3.588-4.655-3.629-5.957C1.642,150.174,6.612,151.968,3.656,148.545z"
          ...
          <a xlink:href="#rondonia" @click="handleClick('RO')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-0.384-6.081-1.028-1.986-3.382-1.903C94.336,180.686,85.957,181.671,83.34,180.232z"
          ...
          <a xlink:href="#matogrosso" @click="handleClick('MT')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C143.581,176.618,141.937,174.714,142.237,173.962z"
          ...
          <a xlink:href="#mattogrossodosul" @click="handleClick('MS')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c0.932-2.847,1.411-9.912,0.453-11.856c-0.165-0.331-3.52-7.232-2.547-8.108C186.306,297.688,182.334,299.415,183.198,294.536z"
          ...
          <a xlink:href="#goias" @click="handleClick('GO')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-3.724-0.604,1.04-3.231,0.22-4.109c-1.89-1.916-4.382,1.756-3.588-3.012C239.602,274.627,237.055,273.038,237.768,270.519z"
          ...
          <a xlink:href="#parana" @click="handleClick('PR')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-3.875-1.449-2.698-6.491-6.054-8.216C226.663,364.623,222.498,367.8,222.225,363.694z"
          ...
          <a xlink:href="#santacatarina" @click="handleClick('SC')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C276.085,411.866,233.534,382.918,231.029,383.959z"
          ...
          <a xlink:href="#riograndedosul" @click="handleClick('RS')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-2.3-1.999-4.793-5.479-7.737-6.68c-3.478-1.367-5.615,5.145-9.052,0.821C189.168,418.854,190.332,418.032,191.236,416.881z"
          ...
          <a xlink:href="#saopaulo" @click="handleClick('SP')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        C247.982,330.386,239.876,331.21,239.3,330.554z"
          ...
          <a xlink:href="#minasgerais" @click="handleClick('MG')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-4.708-0.353-5.53-1.613-9.858,0.631C262.993,300.562,262.336,299.274,262.881,297.305z"
          ...
          <a xlink:href="#riodejaneiro" @click="handleClick('RJ')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-6.211,0-11.263-5.054-11.263-11.264C343.831,323.634,348.883,318.613,355.094,318.613z"
          ...
          <a xlink:href="#espiritosanto" @click="handleClick('ES')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-6.212,0-11.263-5.049-11.263-11.261C370.654,289.777,375.705,284.723,381.917,284.723z"
          ...
          <a xlink:href="#distritofederal" @click="handleClick('DF')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
        ...
        c-6.209,0-11.261-5.053-11.261-11.263C289.475,243.377,294.523,238.34,300.735,238.34z"
          ...
          <a xlink:href="#paraiba" @click="handleClick('PB')">
            <path
              stroke="#FFFFFF"
              stroke-width="1.0404"
              stroke-linecap="round"
...
#svg-map a:hover path {
  fill: #d16fff !important;
}
#svg-map .circle {
  fill: #7dc143;
}
#svg-map a:hover .circle {
  fill: #2f2e41 !important;
  cursor: pointer;
}
</style>
